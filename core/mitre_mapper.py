...
MITRE_TECHNIQUES = {
    ...
    "T1059.006": MitreTechnique("T1059.006", "Python", "Execution", "Adversaries may abuse Python to execute malicious code and automation.", "Monitor for python.exe or pythonw.exe spawned by unusual parents such as services.exe or svchost.exe", "https://attack.mitre.org/techniques/T1059/006"),
